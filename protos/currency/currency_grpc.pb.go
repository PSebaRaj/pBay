...
func (c *currencyClient) GetExchangeRate(ctx context.Context, in *RateRequest, opts ...grpc.CallOption) (*RateResponse, error) {
...
func (UnimplementedCurrencyServer) GetExchangeRate(context.Context, *RateRequest) (*RateResponse, error) {
...
func _Currency_GetExchangeRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CurrencyServer).GetExchangeRate(ctx, req.(*RateRequest))
	}
